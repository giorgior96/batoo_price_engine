...
def generate_dual_language_email(broker_name, stats, specific_boat):
    ...
    tool_link = "https://batoo-analytics-3sd9.vercel.app/"
    ...
    # We include the link directly now
    it_cta_intro = "Abbiamo da poco lanciato la versione Beta del tool. Potete <b>provarlo subito e gratuitamente</b> qui:"
    it_cta_button = "Prova Batoo Analytics"
    it_reply = f"Per qualsiasi domanda o per avere un'analisi personalizzata del vostro portafoglio, <b>rispondete a questa email</b> o scrivetemi su WhatsApp al <a href='{whatsapp_link}' style='color: #2563eb; text-decoration: none;'>+39 345 459 0116</a>."
    ...
    en_cta_intro = "We recently launched the Beta version of our tool. You can <b>try it now for free</b> here:"
    en_cta_button = "Try Batoo Analytics"
    en_reply = f"For any questions or to get a custom analysis of your portfolio, <b>reply to this email</b> or message me on WhatsApp at <a href='{whatsapp_link}' style='color: #2563eb; text-decoration: none;'>+39 345 459 0116</a>."
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="cta-section">
                    ...
                    <a href="{tool_link}" class="cta-btn">{it_cta_button if primary == 'it' else en_cta_button}</a>
                </div>
                ...
                <div class="cta-section">
                    ...
                    <a href="{tool_link}" class="cta-btn">{en_cta_button if primary == 'it' else it_cta_button}</a>
                </div>
...
def fallback_boat():
    # Modello sempreverde e super liquido
    return {
        "name": "Axopar 37",
        "year": 2021,
        "depreciation": 5.8,
...
def get_best_boat_data(top_models_list, df_boats):
    """
    Cerca il primo modello tra i top del broker che abbia abbastanza dati (almeno 5 barche).
    Se nessuno è sufficiente, ritorna l'Axopar 37 come fallback (è un dato reale e funziona benissimo come esca).
    """
        ...
        if len(matched) >= 5:
            ...
            if not prices.empty:
                ...
                return {
                    "name": model_name,
                    "year": year,
                    "depreciation": 4.5, # Dato conservativo per la demo
                    "liquidity_it": liq_it,
                    "liquidity_en": liq_en,
                    "avg_price": avg_price
                }
...
def send_test(to_email, smtp_pass):
    # Carichiamo finto DB per testare la funzione
    df_boats = pd.DataFrame([
        {'builder': 'Azimut', 'model': '60', 'price_eur': 900000, 'year_built': 2018},
        {'builder': 'Azimut', 'model': '60', 'price_eur': 950000, 'year_built': 2019},
        {'builder': 'Azimut', 'model': '60', 'price_eur': 990000, 'year_built': 2019},
        {'builder': 'Azimut', 'model': '60', 'price_eur': 890000, 'year_built': 2017},
        {'builder': 'Azimut', 'model': '60', 'price_eur': 1050000, 'year_built': 2020},
    ])
    ...
    stats = {
        ...
        'lang': 'it' # Facciamo finta sia italiano
    }
    ...
    try:
        ...
        server.quit()
        print(f"✅ Email inviata con successo (IT principale) a {to_email}")
