...
def generate_html_email(broker_name, stats, specific_boat=None, lang='it'):
    ...
    if lang == 'it':
        ...
        reply_text = "Se preferite, potete semplicemente <b>rispondere a questa email</b> o scrivermi su WhatsApp al <a href='{whatsapp_link}' style='color: #2563eb; text-decoration: none;'>+39 345 459 0116</a> per ricevere un report PDF gratuito."
        ...
        reply_text = "Alternatively, you can simply <b>reply to this email</b> or message me on WhatsApp at <a href='{whatsapp_link}' style='color: #2563eb; text-decoration: none;'>+39 345 459 0116</a> to receive a free PDF report."
        signoff = "Best regards,"
        signature = "Giorgio Rota<br>Founder, Batoo Analytics<br><a href='https://www.batoo.it' style='color: #64748b; text-decoration: none;'>www.batoo.it</a>"

    reply_text = reply_text.format(whatsapp_link=whatsapp_link)
    ...
    if specific_boat:
        ...
        <div class="boat-analysis">
            ...
            <p style="font-size: 14.5px; margin-bottom: 12px;">{boat_text}</p>
            <ul class="features">
                <li>{li_dep}</li>
                <li>{li_liq}</li>
                <li>{li_price}</li>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="font-size: 14.5px;">{pitch_text}</p>
                <ul class="features">
                    <li>{point1}</li>
                    <li>{point2}</li>
                    <li>{point3}</li>
...
{reply_text.replace('<b>','').replace('</b>','').replace("<a href='{whatsapp_link}' style='color: #2563eb; text-decoration: none;'>", "").replace("</a>", "")}
...
def send_test_email(to_email, smtp_user, smtp_pass, test_lang='it'):
    ...
    broker_name = "SuperYachts International" if test_lang == 'en' else "Timone Yachts"
    
    specific_boat = {
        "name": "Azimut 60",
        "year": 2018,
        "depreciation": 4.5,
        "liquidity": "Alta (Vendita in ~30 gg)" if test_lang == 'it' else "High (Sales in ~30 days)",
        "avg_price": 950000
    }
    
    subject, plain_text, html_content = generate_html_email(broker_name, stats, specific_boat, lang=test_lang)

    msg = MIMEMultipart('alternative')
    msg['Subject'] = f"[TEST {test_lang.upper()}] " + subject
    ...
    try:
        ...
        server.quit()
        print(f"✅ Email di test ({test_lang.upper()}) inviata con successo a {to_email}")
        return True
...
if __name__ == "__main__":
    ...
    print("Invio delle email di test con il nuovo copy...")
    send_test_email(sender_email, sender_email, app_password, test_lang='it')
    time.sleep(2)
    send_test_email(sender_email, sender_email, app_password, test_lang='en')